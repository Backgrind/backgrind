...
| **Plus** | $9/mo · $92/yr | The complete local app: saved projects, workspaces, up to 3 parallel agents, voice input. No server involved. |
| **Pro** | $39/mo · $375/yr | Everything in Plus, **unlimited parallel agents**, the hosted **`grindy-1` · `grindy-1-pro`** models (no API key needed), cloud sync, priority support. |
