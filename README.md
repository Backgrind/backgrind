...
| **Plus** | **$19/mo** | The complete local app: workspaces, unlimited parallel agents, voice, customization, and **Live mode** — drive your agents from any browser, end-to-end encrypted. Bring your own CLI. |
