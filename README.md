...
<p align="center">
  <strong>Code while you grind.</strong> Run your AI coding agent — Claude Code, Codex, or Cursor —
...
- 🧠 **Bring your own CLI** — wraps the real Claude Code / Codex / Cursor login you already have.
...
Grab the latest **macOS / Windows** build from **[Releases](../../releases)**. The Free tier is a
full-featured demo — connect your own Claude Code or Cursor CLI and try it over a real game.
...
|---|---|---|
| **Free** | $0 | The full overlay with your own Claude Code / Codex / Cursor. 1 agent, session-only — nothing saved between launches. |
| **Plus** | $9/mo | The complete local app: saved projects, workspaces, up to 3 parallel agents, voice input. No server involved. |
| **Pro** | $29/mo | Everything in Plus, **unlimited parallel agents**, the hosted **`grindy-1` · `grindy-1-pro`** models (no API key needed), cloud sync, priority support. |
